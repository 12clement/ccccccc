...
def assert_dataframe_equal(res_flatten_kafka_source_df,  res_flatten_rds_df):
    ...
    # s3_pd_df = res_flatten_s3_df.toPandas()
...
def load_data(spark):
    ...
    df = spark.read.option("multiline", "true") \
        .json("C:\\Users\\ctagb\\workspace_python\\pythonProject\\pythonProject\\data\\policy_cancel_kafka.json")
    ...
    # df_s3 = spark.read \
    #     .text("C:\\Users\\ctagb\\workspace_python\\pythonProject\\pythonProject\\data\\policy_cancel_s3.txt")
    # res_flatten_s3_df = flatten_and_sort_dataframe(df_s3)
    # #res_flatten_s3_df.printSchema()
    # dataframes.append(res_flatten_s3_df)

    df_rds = spark.read.option("multiline", "true") \
        .json("C:\\Users\\ctagb\\workspace_python\\pythonProject\\pythonProject\\data\\policy_cancel_rds.txt")
