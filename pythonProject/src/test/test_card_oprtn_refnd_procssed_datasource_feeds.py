...
from src.utils.definitions import card_operation_refund_processed_mandatory_column_value_list
...
def validate_not_null_fields(res_flatten_kafka_source_df):
    ...
    for field in card_operation_refund_processed_mandatory_column_value_list:
...
def load_data(spark):
    ...
    df_rds = spark.read.option("multiline", "true") \
        .json("C:\\Users\\ctagb\\workspace_python\\pythonProject\\pythonProject\\data\\ext_refund_created_rds.txt")
