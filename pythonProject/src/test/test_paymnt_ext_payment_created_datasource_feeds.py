...
from src.utils.definitions import  payment_ext_payment_created_mandatory_column_value_list
...
def validate_not_null_fields(res_flatten_kafka_source_df):
    ...
    for field in payment_ext_payment_created_mandatory_column_value_list:
...
def load_data(spark):
    ...
    df = spark.read.option("multiline", "true") \
        .json("C:\\Users\\ctagb\\workspace_python\\pythonProject\\pythonProject\\data\\paymnt_ext_payment_created_kafka.json")
    ...
    df_rds = spark.read.option("multiline", "true") \
        .json("C:\\Users\\ctagb\\workspace_python\\pythonProject\\pythonProject\\data\\paymnt_ext_payment_created_rds.txt")
