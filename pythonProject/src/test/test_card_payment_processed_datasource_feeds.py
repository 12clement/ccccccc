...
from src.utils.definitions import card_payment_processed_mandatory_column_value_list
...
def validate_not_null_fields(res_flatten_kafka_source_df):
    ...
    for field in card_payment_processed_mandatory_column_value_list:
...
def load_data(spark):
    ...
    df = spark.read.option("multiline", "true") \
        .json("C:\\Users\\ctagb\\workspace_python\\pythonProject\\pythonProject\\data\\card_payment_processed_kafka.json")
    ...
    df_rds = spark.read.option("multiline", "true") \
        .json("C:\\Users\\ctagb\\workspace_python\\pythonProject\\pythonProject\\data\\card_payment_processed_rds.txt")
    ...
    res_flatten_rds_df = spark.createDataFrame(pd_flatten_rds_df)
